@php
    $categorice = App\Models\category::all();
@endphp
<!DOCTYPE html>
<html lang="en">
   <head>
      ...
      @vite(['public/frontend/css/bootstrap.min.css'])
   ...
   <body>
            ...
            <div class="container">
               <div class="containt_main">
                  <div id="mySidenav" class="sidenav">
                     ...
                     @foreach ($categorice as $category)
                     <a class="dropdown-item" href="{{ route('category',['id'=>$category->id,'slug'=>$category->category_slug]) }}">{{ $category->category_name }}</a>
                @endforeach
                  ...
                  <div class="main">
                     ...
                     <div class="input-group">
                         <form action="{{ route('search') }}" > {{--search --}}
                            ...
                            <div class="input-group ml-5" style="width: 500px">
                  ...
                  <div class="header_box">
                     ...
                     <div class="login_menu">
                        @php
                             $addTocard_count =  App\Models\addtocard::where('user_id',Auth()->id())->count();
                        @endphp
                        <ul>
                           <li class="p-2"><a href="{{ route('checkout') }}" >
                                <i class="fa fa-shopping-cart" aria-hidden="true"></i> Cart
                                <span class="badge rounded-pill badge-center h-px-20 w-px-20 bg-label-danger">{{  $addTocard_count }}</span>
      ...
      <!-- banner bg main end -->
      <div class="containe " style="margin-top: 500px">
            @yield('webpag')
      </div>
